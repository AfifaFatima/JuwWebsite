...
<body>
            ...
            <div class="signup-box">
                ...
                <form name="Registration" action="" method="post">
                    <div class="signup">
                        ...
                        <input class="form-control" type="text" name="ID" placeholder="Librarian ID" maxlength="50"
                         required=""><br>
    ...
    <?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        if($count==0)
        {
          mysqli_query($db,"INSERT INTO `ADMIN` VALUES('', '$_POST[username]', '$_POST[password]', '$_POST[email]', '$_POST[mobile_no]', 'pic.png');");
        ?>
